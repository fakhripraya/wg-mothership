...
import {
  ...
  styleSlideLeft,
  styleSlideRight,
} from "../../variables/styles/carousel";
...
export default function ImageSlider(props) {
  ...
  useEffect(() => {
    ...
    const renderCurrent = {
      currentPrev:
        carouselData[
          prevArrayItem(carouselData[0], carouselData)
        ],
      current: carouselData[0],
      currentNext:
        carouselData[
          nextArrayItem(carouselData[0], carouselData)
        ],
    };
  ...
  return (
    <div
      ...
      <FloatButton
        ...
        className="imageslider-button imageslider-right-button">
        ❱
      </FloatButton>
    </div>
  );
