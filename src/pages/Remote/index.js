    ...
    const ShowBody = () => {
        return itemListDummy.map((item, index) => {
            return <div key={`remote-items-${index}`} className="remote-body margin-top-12-18 dark-bg-color">
                ...
                <div className="remote-body-items remote-body-cpu-spec">
                ...
                <div className="remote-body-items remote-body-graphical-spec">
                ...
                <div className="remote-body-items remote-body-storage-spec">
                    <ShowAccordion datas={item.storageList} />
                </div>
                <div className="remote-body-items remote-body-rent-detail">
