      ...
      <div className="rdp-wrapper">
        <div className="rdp-textinput-box">
          ...
          <h4 className="margin-top-0 margin-bottom-12-18">
            Input the invitation{" "}
            <span className="main-color">code</span> from
            your rental host, if you haven't get the code
            you can ask the host to{" "}
            <span className="main-color">re-generate</span>{" "}
            the code
          </h4>
          <TextInput
            onChange={(e) => setRoomCode(e.target.value)}
            type="text"
            className="rdp-textinput text-align-center"
          />
          <Button
            onClick={() => answerRDPInvitation()}
            className="rdp-button-connect">
            Connect
          </Button>
        </div>
      </div>
