      ...
      <BottomSheet
        ...
        <div className="dashboard-mobile-menu-container">
          ...
          <FloatButton
            ...
            className="dashboard-menu-button dashboard-menu-button-home"></FloatButton>
          <br />
          <br />
          <FloatButton
            onClick={() =>
            ...
            className="dashboard-menu-button dashboard-menu-button-order"></FloatButton>
          <br />
          <br />
          <FloatButton
            onClick={() =>
          ...
          <FloatButton
            ...
            className="dashboard-menu-button dashboard-menu-button-product"></FloatButton>
        </div>
      </BottomSheet>
    </Fragment>
  );
