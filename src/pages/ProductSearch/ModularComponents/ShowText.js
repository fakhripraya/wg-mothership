...
export const ShowSearchText = (props) =>
  useCallback(() => {
    if (props.isLoading)
      ...
      return (
        <span>
          Kita udah tampilin semua produk berdasarkan
          kriteria pencarian kamu nih, totalnya ada{" "}
          <strong>
      ...
      return (
        <span>
          ...
          produk dari {props.searchedProductsMasterCount}{" "}
          dulu ya, kalau mau liat lagi pencet{" "}
      ...
      return (
        ...
        <span>
          Wah maaf nih kayanya itemnya belum ada, coba
