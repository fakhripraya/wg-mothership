...
import { typeValues } from "../../variables/initial/global";
...
export default function AddCatalogue() {
  ...
  const ShowUploadModal = () => {
    return (
      <div className="add-catalogue-upload-container dark-bg-color">
        ...
        <div className="add-catalogue-wrapper">
          <div className="add-catalogue-text-container">
            <div className="add-catalogue-text-wrapper">
              ...
              <h3 className="margin-top-0 margin-bottom-12-18">
                What about the{" "}
                <span className="main-color">physical</span>{" "}
                information ?
              </h3>
              {data.productPrices.map((val, index) => {
                return (
                  <div
                    key={`add-catalogue-product-prices-${index}`}
                    ...
                    <TextInput
                      value={
                        data.productPrices[index].price
                      }
                      onChange={(e) =>
              ...
              <Button
                onClick={() =>
                  handleAddComponent("productPrices", {
                    ...defaultPrice,
                  })
                }
                className="align-self-end add-catalogue-button main-bg-color">
              ...
              <h2 className="margin-bottom-12-18">
                Set the{" "}
                <span className="main-color">stocks</span>
              </h2>
              <h3 className="margin-top-0 margin-bottom-12-18">
                You need to set the{" "}
                <span className="main-color">stocks</span>{" "}
                of your product so your customer know when
                it is available
              </h3>
              <div className="add-catalogue-textinput-box">
                <label className="add-catalogue-input-title">
              ...
              <h3 className="margin-top-0 margin-bottom-12-18">
                You need to set the pickup plan so anyone
                that interested to rental your product would
                know the{" "}
                <span className="main-color">
                  picking info
                </span>
              ...
              <div className="add-catalogue-textinput-box">
                ...
                <TextInput
                  ...
                  onChange={(e) =>
                    handleTextChange("pickupSubdistrict", e)
                  }
                  type="text"
                  className="add-catalogue-textinput"
                />
              ...
              <div className="add-catalogue-textinput-box">
                ...
                <TextInput
                  ...
                  onChange={(e) =>
                    handleTextChange("pickupAddress", e)
                  }
                  type="text"
                  className="add-catalogue-textinput"
                />
              ...
              <div className="add-catalogue-textinput-box">
                ...
                <TextInput
                  ...
                  onChange={(e) =>
                    handleTextChange("pickupPostalCode", e)
                  }
                  type="text"
                  className="add-catalogue-textinput"
                />
              ...
              <h3 className="margin-top-0 margin-bottom-12-18">
                ...
                to pick up before{" "}
                <span className="red-color">cancel</span> ?
              </h3>
              <div className="add-catalogue-textinput-box">
                <TextInput
                  value={data.productMaxWaitTime}
                  onChange={(e) =>
                    handleTextChange(
                      "productMaxWaitTime",
                      e
                ...
                <Dropdown
                  ...
                  showTitle={false}
                  toggle={true}
                  values={waitTimeValues}
                />
              </div>
              <br />
              <h2 className="margin-bottom-12-18">
                Set the{" "}
                <span className="main-color">courier</span>
              </h2>
              <h3 className="margin-top-0 margin-bottom-12-18">
                You need to set the pickup plan so anyone
                that interested to rental your product would
              ...
              <h3 className="margin-top-0 margin-bottom-12-18">
                ...
                for the product rental process so you can
                make sure that everything is secure on your
                side
              </h3>
              <MultiUpload
              ...
              <div className="add-catalogue-textinput-box">
                <Checkbox
                  ...
                  title={
                    "By ticking, you are confirming that you have read and agree to the terms & condition"
                  }
                />
              </div>
              <Button
